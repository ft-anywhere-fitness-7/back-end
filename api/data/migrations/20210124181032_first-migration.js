exports.up = async (knex) => {
  await knex.schema
    ...
    .createTable("classes", (classes) => {
      ...
      classes.integer("class_instructor")
        .unsigned()
        .notNullable()
        .references("user_id")
        .inTable("users")
    ...
    .createTable("classes_students", (classes_students) => {
      ...
      classes_students.integer("student_id")
      .unsigned()
      .notNullable()
      .references("user_id")
      .inTable("users")
      .onUpdate("CASCADE")
      .onDelete("CASCADE")
      classes_students.integer("class_id")
      .unsigned()
      .notNullable()
      .references("class_id")
      .inTable("classes")
